...
import t3h.domain.InvoiceDetail;
import t3h.mapper.InvoiceDetailMapper;
import t3h.mapper.InvoiceMapper;

public class InvoiceRepository extends Repository{
    public int add(Invoice obj) {
		return jdbc.update("CALL AddInvoice(?,?,?,?,?)",obj.getId(),obj.getMemberId(),
