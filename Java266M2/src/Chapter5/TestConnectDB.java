...
public class TestConnectDB {
	...
	public static void main(String[] args) {
		...
		try {
			...
			// B5: Thuc thi truy van -> goi ham executeQuery (select) va executeUpdate (insert,update,delete)
			// cua doi tuong Statement -> Ket qua duoc quan ly boi doi tuong ResultSet (select)
			String sqlUpdate = "update nhan_vien set ho_ten = 'Pham Duc De' where id = 1";
